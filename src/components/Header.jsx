...
function Header() {
  ...
  const fetchUserProfile = async () => {
    ...
    if (accessToken) {
      try {
        const response = await axios.get('https://storycreator-talestogether.onrender.com/api/user-profile/', {
          headers: {
  ...
  const renderProfilePicture = () => {
    if (userProfile && userProfile.image) {
      const imageUrl = userProfile.image.startsWith('http') ? userProfile.image : `https://storycreator-talestogether.onrender.com${userProfile.image}`;

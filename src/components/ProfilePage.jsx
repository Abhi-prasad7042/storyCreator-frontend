...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        // Fetch profile data
        const profileResponse = await axios.get('https://storycreator-talestogether.onrender.com/api/user-profile/', {
          headers: {
        ...
        // Fetch all stories
        const storiesResponse = await axios.get('https://storycreator-talestogether.onrender.com/api/stories/');
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put('https://storycreator-talestogether.onrender.com/api/user-profile/', formData, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8 text-center">
          ...
          >
            {profileImage ? (
              ...
              <img
                src={`https://storycreator-talestogether.onrender.com${profileData.image}`}
                alt="Profile"
                className="w-full h-full object-cover rounded-full"
              />
            ) : (
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="relative w-4/5 h-4/5 bg-gray-800 p-4 rounded-lg flex flex-col items-center justify-center bg-opacity-85">
            ...
            <img
              src={profileImage || `https://storycreator-talestogether.onrender.com${profileData.image}`}
              alt="Profile Preview"
